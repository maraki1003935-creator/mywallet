    ...
    try {
        ...
        if (
            ...
            if (!user.referredBy) {
                ...
                console.log(
                    "THIS USER HAS NO referredBy VALUE."
                );

            } else {

                console.log(
                    "NEW USER BONUS WAS ALREADY PAID."
                );
        ...
        if (referrerBonus === 600) {

            userMessage +=
                " Your referrer also received 600 ETB.";

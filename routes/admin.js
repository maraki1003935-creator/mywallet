...
router.post("/deposit/approve/:id", verifyAdmin, async (req, res) => {
    ...
    try {
        ...
        // Referral bonus (only first approved deposit)
        if (user.referredBy && !user.referralPaid) {
            ...
            if (referrer) {
                ...
                await Notification.create({
                    ...
                    message: "600 ETB referral bonus has been added to your wallet."
                });
        ...
        await Notification.create({
            ...
            message: deposit.amount + " ETB has been added to your wallet."
        });
